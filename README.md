...
- Write the user names and chat_id of you want to authorize, each separated by new line into the authorised_chats.txt
- If none, then delete the authorised_chats.txt file before you push.
